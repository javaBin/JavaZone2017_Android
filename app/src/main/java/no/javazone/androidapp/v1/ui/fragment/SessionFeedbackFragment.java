...
import no.javazone.androidapp.v1.ui.activity.SessionFeedbackActivity;
import no.javazone.androidapp.v1.ui.widget.NumberRatingBar;
import no.javazone.androidapp.v1.util.AnalyticsHelper;
import no.javazone.androidapp.v1.util.Constants;
import no.javazone.androidapp.v1.util.RestServiceDevNull;
...
public class SessionFeedbackFragment extends Fragment
        implements UpdatableView<SessionFeedbackModel, SessionFeedbackModel.SessionFeedbackQueryEnum,
        SessionFeedbackModel.SessionFeedbackUserActionEnum> {
    ...
    @Override
    public void displayData(SessionFeedbackModel model, SessionFeedbackModel.SessionFeedbackQueryEnum query) {
    ...
    @Override
    public void displayErrorMessage(SessionFeedbackModel.SessionFeedbackQueryEnum query) {
        getActivity().finish();
    }

    @Override
    public void displayUserActionResult(SessionFeedbackModel model, SessionFeedbackModel.SessionFeedbackUserActionEnum userAction, boolean success) {

    }

    @Override
    public Uri getDataUri(SessionFeedbackModel.SessionFeedbackQueryEnum query) {
        if (SessionFeedbackModel.SessionFeedbackQueryEnum.SESSION == query) {
