...
import no.javazone.androidapp.v1.database.ScheduleContractHelper;
import no.javazone.androidapp.v1.feedback.FeedbackHelper;
...
public class SessionAlarmService extends IntentService {
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "no.javazone.androidapp.v1.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "no.javazone.androidapp.v1.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "no.javazone.androidapp.v1.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "no.javazone.androidapp.v1.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "no.javazone.androidapp.v1.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "no.javazone.androidapp.v1.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "no.javazone.androidapp.v1.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "no.javazone.androidapp.v1.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "no.javazone.androidapp.v1.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "no.javazone.androidapp.v1.extra.SESSION_TITLE";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("no.javazone.androidapp.v1")
