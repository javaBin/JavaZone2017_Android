...
import no.javazone.androidapp.v1.archframework.model.SessionDetailModel;
...
import no.javazone.androidapp.v1.ui.widget.CheckableFloatingActionButton;
import no.javazone.androidapp.v1.ui.widget.MessageCardView;
...
import no.javazone.androidapp.v1.util.SessionDetailConstants;
import no.javazone.androidapp.v1.util.SessionsHelper;
import no.javazone.androidapp.v1.util.TimeUtils;
import no.javazone.androidapp.v1.util.UIUtils;

import no.javazone.androidapp.v1.archframework.model.SessionDetailModel.SessionDetailQueryEnum;
import no.javazone.androidapp.v1.archframework.model.SessionDetailModel.SessionDetailUserActionEnum;
