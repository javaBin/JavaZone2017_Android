...
import no.javazone.androidapp.v1.util.ExtendedSessionHelper;
...
public class SessionDetailModel
    ...
    public boolean hasLiveStream() {
        return mHasLiveStream || (!TextUtils.isEmpty(mVideoUrl) && !mVideoUrl.equals("null"));
    }
    ...
    public boolean shouldShowHeaderImage() {
        boolean hasYouTubeUrl = !TextUtils.isEmpty(mVideoUrl) && !mVideoUrl.equals("null");
