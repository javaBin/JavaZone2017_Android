...
public class AccountUtils {
    ...
    private static final String PREF_ACTIVE_ACCOUNT = "no.javazone.androidapp.v1";
    private static final String DUMMY_ACCOUNT_NAME = "no.javazone.androidapp.v1";
    private static final String DUMMY_ACCOUNT_TYPE = "no.javazone.androidapp.v1";
