...
public class FirebaseUtils {
    ...
    private static final String TAG = makeLogTag(FirebaseUtils.class);
    ...
    public static String getFirebaseUid(final Context context) {
        ...
        return sp.getString(
                makeAccountSpecificPrefKey("no.javazone.androidapp.v1", PREFIX_PREF_FIREBASE_UID), "");
    }
    ...
    public static String getFirebaseUrl(Context context, String accountName) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        return sp.getString(
                makeAccountSpecificPrefKey("no.javazone.androidapp.v1",
    ...
    public static void setFirebaseUrl(Context context, String accountId) {
        ...
        sp.edit().putString(
                makeAccountSpecificPrefKey("no.javazone.androidapp.v1", PREFIX_PREF_FIREBASE_URL),
